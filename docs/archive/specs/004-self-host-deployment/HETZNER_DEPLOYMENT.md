...
**Image**: 
- Select **"Ubuntu"** → **"22.04"** (recommended) or **"24.04"** (also works)
- **Why 22.04?** See [RESOURCE_REQUIREMENTS.md](./RESOURCE_REQUIREMENTS.md) for details

**Type** (choose based on needs - see [RESOURCE_REQUIREMENTS.md](./RESOURCE_REQUIREMENTS.md) for detailed RAM analysis):
- **CPX11** (2 vCPU, 4GB RAM, 80GB SSD) - **€4.51/month** ⚠️ Minimum, tight fit
- **CPX21** (3 vCPU, 8GB RAM, 160GB SSD) - **€8.11/month** ✅ **Recommended** - Good balance
- **CPX31** (4 vCPU, 8GB RAM, 240GB SSD) - **€15.21/month** - More CPU, same RAM
- **CPX41** (8 vCPU, 16GB RAM, 360GB SSD) - **€29.21/month** - For heavy usage

**RAM Explanation**: Your app uses ArangoDB (graph DB) and Qdrant (vector DB), both memory-intensive. See [RESOURCE_REQUIREMENTS.md](./RESOURCE_REQUIREMENTS.md) for why 8GB is recommended.

**SSH Keys**:
- **👉 See [SSH_KEY_SETUP.md](./SSH_KEY_SETUP.md) for complete SSH key setup guide!**
- **Quick version**: Click **"Add SSH Key"** → Paste your public key → Name it
- **If you don't have a key**: See [SSH_KEY_SETUP.md](./SSH_KEY_SETUP.md) Step 2
- **Why SSH keys?** More secure and convenient than passwords (no typing password each time)
...
### CPX11 (Minimum, tight fit)
- **Server**: €4.51/month
- **Backups** (optional): +€0.90/month
- **Total**: €4.51-5.41/month
- ⚠️ **Note**: 4GB RAM may be tight - monitor usage closely

### CPX21 (Recommended - Good balance) ⭐
- **Server**: €8.11/month
- **Backups** (optional): +€1.62/month
- **Total**: €8.11-9.73/month
- ✅ **Best value**: Comfortable headroom for production

### CPX31 (More CPU, same RAM)
- **Server**: €15.21/month
- **Note**: Same RAM as CPX21, more CPU cores

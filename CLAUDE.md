...
This project is indexed by GitNexus as **tenant-legal-tools** (2931 symbols, 5508 relationships, 226 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/tenant-legal-tools/context` | Codebase overview, check index freshness |
| `gitnexus://repo/tenant-legal-tools/clusters` | All functional areas |
| `gitnexus://repo/tenant-legal-tools/processes` | All execution flows |
| `gitnexus://repo/tenant-legal-tools/process/{name}` | Step-by-step execution trace |

...
from tenant_legal_guidance.services.concept_grouping import ConceptGroupingService, ConceptGroup
...
class TestConceptGroupingService:
    ...
    def test_find_similar_entities(self):
        ...
        similar_entities = self.service.find_similar_entities(
            query_entity, candidates, top_k=2
        )
    ...
    def test_suggest_relationships(self):
        ...
        suggestions = self.service.suggest_relationships(
            self.test_entities, existing_relationships
        )

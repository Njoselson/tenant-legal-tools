...
- **[RESOURCE_REQUIREMENTS.md](./RESOURCE_REQUIREMENTS.md)** - ⭐ RAM, CPU, and Ubuntu version guide
- **[SSH_KEY_SETUP.md](./SSH_KEY_SETUP.md)** - SSH key setup guide (recommended for security)
